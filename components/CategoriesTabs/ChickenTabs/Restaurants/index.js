...
const DATA = [
  {
    id: 'd1',
    title: 'Popeyes',
    img: require('../../../../assets/Images/Categories/Chicken/Restaurants/popeyes.jpg'),
    speciality: 'Fried Chicken, Burgers, Sandwishes, Chicken Buckets.',
    location: 'Guilez',
    ratings: '90%',
    time : '20 min',
  },

  {
    id: 'd2',
    title: 'Chick-fil-a',
    img: require('../../../../assets/Images/Categories/Chicken/Restaurants/chickfila.jpg'),
    speciality: 'Fried Chicken, Burgers, Sandwishes, Chicken Nuggets.',
    location: 'Guilez',
    ratings: '91%',
    time : '12 min',
  },

  {
    id: 'd3',
    title: 'KFC',
    img: require('../../../../assets/Images/Categories/Chicken/Restaurants/kfc.jpg'),
    speciality: 'Fried Chicken, Burgers, Sandwiches, Drinks, Nuggets.',
    location: 'Guilez',
    ratings: '85%',
    time : '32 min',
  },

  {
    id: 'd4',
    title: 'Jollibee ',
    img: require('../../../../assets/Images/Categories/Chicken/Restaurants/joliibee.jpg'),
    speciality: 'Chicken Buckets, Yumburgers, Spaghetti, Burgers, Steak.',
    location: 'Guilez',
    ratings: '86%',
    time : '15 min',
  },
