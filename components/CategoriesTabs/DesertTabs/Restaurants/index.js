...
const DATA = [
  {
    id: 'd1',
    title: 'Cookie Man',
    img: require('../../../../assets/Images/Categories/Desert/Restaurants/cookieman.jpg'),
    speciality: 'Cookies, Bakery, Smoothies, Soft Drinks.',
    location: 'Guilez',
    ratings: '85%',
    time : '20 min',
  },

  {
    id: 'd2',
    title: 'Mr Puffs',
    img: require('../../../../assets/Images/Categories/Desert/Restaurants/puffs.jpg'),
    speciality: 'Bakery, Croissant, Smoothies, Sandwishes.',
    location: 'Guilez',
    ratings: '91%',
    time : '12 min',
  },

  {
    id: 'd3',
    title: 'Cinnabon',
    img: require('../../../../assets/Images/Categories/Desert/Restaurants/cinnabon.jpg'),
    speciality: 'Croissant, Cakes, Bakery, Icecream, Smoothies.',
    location: 'Guilez',
    ratings: '95%',
    time : '32 min',
  },

  {
    id: 'd4',
    title: 'Krispy Kreem',
    img: require('../../../../assets/Images/Categories/Desert/Restaurants/krispy.jpg'),
    speciality: 'Cheese Cakes, Cakes, Croissant, Soft Drinks, Cheese.',
    location: 'Guilez',
    ratings: '80%',
    time : '15 min',
  },
