...
const DATA = [
  {
    id: 'd1',
    title: 'MCdonalds',
    img: require('../../../../assets/Images/Categories/Drinks/Restaurants/mcdonalds.jpg'),
    speciality: 'Fried Chicken, Burgers, Sandwishes, Drinks.',
    location: 'Guilez',
    ratings: '90%',
    time : '20 min',
  },

  {
    id: 'd2',
    title: 'StarBucks',
    img: require('../../../../assets/Images/Categories/Drinks/Restaurants/starbucks.jpg'),
    speciality: 'Drinks, Coffee, Tea, Iced Tea Bakery.',
    location: 'Guilez',
    ratings: '91%',
    time : '12 min',
  },
...

  {
    ...
    speciality: 'Chicken Buckets, Yumburgers, Spaghetti, Burgers, Drinks, Steak.',
    location: 'Guilez',
    ratings: '86%',
    time : '15 min',
  },
