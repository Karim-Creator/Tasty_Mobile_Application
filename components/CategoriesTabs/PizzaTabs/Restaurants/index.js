...
const DATA = [
  {
    id: 'd1',
    title: 'Dominos',
    img: require('../../../../assets/Images/Categories/Pizza/Restaurants/dominos.jpg'),
    speciality: 'Pizza, Fried Chicken, Drinks, Icecream.',
    location: 'Guilez',
    ratings: '85%',
    time : '25 min',
  },

  {
    id: 'd2',
    title: 'Pizza Hut',
    img: require('../../../../assets/Images/Categories/Pizza/Restaurants/pizzahut.jpg'),
...

  {
    id: 'd3',
    title: 'Subway',
    img: require('../../../../assets/Images/Categories/Pizza/Restaurants/caesars.jpg'),
    speciality: 'Pizza, Sandwish, Cakes, Drinks, Icecream.',
    location: 'Guilez',
    ratings: '95%',
    time : '32 min',
  },

  {
    id: 'd4',
    title: 'Burger King',
    img: require('../../../../assets/Images/Categories/Pizza/Restaurants/papajohns.jpg'),
    speciality: 'Pizza, Fried Chicken, Drinks, Fries.',
    location: 'Guilez',
    ratings: '80%',
    time : '43 min',
  },
